...
export function SidePanel() {
  ...
  return (
    <div
      ref={glowRef}
      className="col-span-12 md:col-span-4 border-l border-secondary-container bg-surface-container flex flex-col cursor-pointer overflow-hidden row-span-6 h-full"
    >
      <div className="flex flex-col h-full">
        {navSections.map((section) => (
          ...
          >
            ...
            <h2 className="font-headline-md text-3xl text-primary uppercase">
              {section.label}
            </h2>
